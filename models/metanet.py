...
sys.path.append('..')
import util
from util.network.embedding import Embedding
from util.network.encoder import Encoder
import torch
...
class MetaNet(util.framework.FewShotEventModel):
    ...
    def __init__(self, N, K, embedding, max_length, hidden_size=230):
        ...
        '''
        util.framework.FewShotEventModel.__init__(self, None)
